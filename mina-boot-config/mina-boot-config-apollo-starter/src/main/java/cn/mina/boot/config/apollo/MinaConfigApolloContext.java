 ...
 */
public class MinaConfigApolloContext implements ApplicationContextAware {
    private static final Logger log = LoggerFactory.getLogger(MinaConfigApolloContext.class);
